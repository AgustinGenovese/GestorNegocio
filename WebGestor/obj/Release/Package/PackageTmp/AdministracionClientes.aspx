<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AdministracionClientes.aspx.vb" Inherits="WebGestor.AdministracionClientes" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="container">
        <h2 style="margin-top: 2%; margin-bottom: 2%">Información del Cliente</h2>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (txtID.disabled) {
                btnEliminar.style.display = 'none'; // Ocultar el botón eliminar al cargar la página
            }
        });
        </script>
</asp:Content>
